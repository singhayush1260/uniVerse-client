   ...
   // console.log("imaaaageeee url",imageUrl)
    ...
    return <div className={classes.widget_wrapper}>
      ...
      <div className={classes.right_container}>
        <textarea cols="30" rows="1" placeholder="What's on your mind!" onChange={(e)=> setCaption(e.target.value)}/>
    
      <div className={classes.icons}>
         <label><FcCompactCamera/> <span>Camera</span> </label> 
        ...
        { (containsCaption || containsImage) && <button onClick={()=>createPostButtonClick()}>{isLoading ? <CircularLoader/>  :"Post"}</button>}
        </div>
